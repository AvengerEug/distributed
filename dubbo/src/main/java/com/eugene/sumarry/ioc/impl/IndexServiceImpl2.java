...
public class IndexServiceImpl2 implements IndexService {
    ...
    public void index(URL url) {
        System.out.println("IndexServiceImpl2 index");
    }

    @Override
    public void index2(URL url) {
        System.out.println("IndexServiceImpl2 index2");
    }

    @Override
    public void index3(URL url) {
        System.out.println("IndexServiceImpl2 index3");
    }

    @Override
    public void index4() {
        System.out.println("IndexServiceImpl2 index4");
    }

    @Override
    public void index5(URL url) {
        System.out.println("IndexServiceImpl2 index5");
    }
}
